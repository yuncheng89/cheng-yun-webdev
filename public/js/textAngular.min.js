...
// Uses for this are textarea or input with ng-models and ta-bind='text'
// OR any non-form element with contenteditable="contenteditable" ta-bind="html|text" ng-models
...
D.$options||(D.$options={});// ng-models-options support
...
aa(c,!0),a.restoreSelection(b)},1e3))}),u.on("blur",f.events.blur=function(){H=!1,/* istanbul ignore else: if readonly don't update models */
...
// changes to the models variable from outside the html/text inputs
C.$render=function(){/* istanbul ignore if: Catches rogue renders, hard to replicate in tests */
if(!pa){pa=!0;
// catch models being null or undefined
var a=C.$viewValue||"";
...
// at this point, we need to force the models to update! since the css has changed!
...
/* THIS is not the correct thing to do, here....
   The ngModel is correct, but it is not formatted as the user as done it...
					...
					if (getDomFromHtml(_html).childElementCount !== getDomFromHtml(_model).childElementCount) {
						// the models and the html do not agree
...
// stop updating on key up and update the display/models
...
// this is used when externally the html of an editor has been changed and textAngular needs to be notified to update the models.
